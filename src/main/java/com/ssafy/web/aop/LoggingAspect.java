...
public class LoggingAspect {
    ...
    @Before(value = "execution(* com.ssafy.web.controller.*.*(..))")
    ...
    @Around(value = "execution(* com.ssafy.web.component.file.*.*(..))")
    ...
    @AfterReturning(value = "execution(* com.ssafy.web.controller.MemberController.*(..))", returning = "obj")
    ...
    @AfterThrowing(value = "execution(* com.ssafy.web.component.*.*.*(..))", throwing = "exception")
    public void afterThrowingMethod(JoinPoint joinPoint, Exception exception) {
        logger.debug("afterThrowing call method : {}", joinPoint.getSignature());
        logger.debug("exception : {}", exception);
    }

    @After(value = "execution(* com.ssafy.web.controller.*.*(..))")
