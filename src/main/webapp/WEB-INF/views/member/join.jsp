        	...
        	*/
            ...
            $("#registerBtn").click(function () {
                if (!$("#username").val()) {
                    ...
                    $("#memberform").attr("action", "${root}/member/join").submit();
                }
            });
        ...
        <div class="col-lg-8 mx-auto">
            ...
            <form id="memberform" class="text-left mb-3" method="post" action="">
                ...
                <div class="form-group">
                    ...
                    <input type="password" class="form-control" id="userpwd" name="pw" placeholder="비밀번호입력...">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="number" class="form-control" id="userage" name="age" placeholder="나이입력...">
                </div>
                <div class="form-group">
                    <label for="emailid">이메일</label><br>
                    <div id="email" class="custom-control-inline">
                        <input type="text" class="form-control" id="emailid" name="addr" placeholder="이메일아이디입력..."
                            size="25"> @
                        <label for="emaildomain"></label><select class="form-control" id="emaildomain" name="emaildomain">
