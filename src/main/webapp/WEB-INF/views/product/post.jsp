    ...
    <div class="col-lg-8 mx-auto">
        ...
        <form id="writeform" class="text-left mb-3" method="post" enctype="multipart/form-data" action="">
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="name" name="subject" placeholder="제목...">
            </div>
            <div class="form-group">
                <label for="isbn">상품 번호:</label>
                <input type="text" class="form-control" id="isbn" name="content"/>
            </div>
            <div class="form-group">
                <label for="price">상품 가격:</label>
                <input type="number" class="form-control" id="price" name="content"/>
            </div>
            <div class="form-group">
                <label for="explanation">내용:</label>
                <textarea class="form-control" rows="15" id="explanation" name="content"></textarea>
            </div>
